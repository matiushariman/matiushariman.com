...
export function Index() {
  return (
    <div>
      <div className="from-primary to-primary-dark border-gold flex flex-col border-b-8 bg-gradient-to-br p-6 text-white md:fixed md:h-screen md:w-[700px] md:flex-row md:items-center md:justify-around md:border-b-0 md:border-r-8">
