    ...
    <div className="layout">
      <aside className="sidebar">
        <div className="avatar-wrap">
          <Image src="/headshot.png" alt="Matius" fill style={{ objectFit: 'cover' }} />
        </div>
        <div className="sidebar-name">Matius</div>
        <div className="sidebar-title">
          Senior Frontend Engineer<br />& Boston Celtics Fan 🍀
        </div>
        <div className="sidebar-loc">
          <svg width="12" height="12" viewBox="0 0 16 16" fill="none">
            <path d="M8 1.5C5.51 1.5 3.5 3.51 3.5 6c0 3.75 4.5 8.5 4.5 8.5S12.5 9.75 12.5 6c0-2.49-2.01-4.5-4.5-4.5zm0 6.1A1.6 1.6 0 1 1 8 4.3a1.6 1.6 0 0 1 0 3.3z" fill="currentColor" />
          </svg>
          Singapore
        </div>
        ...
        <div className="sidebar-footer">
          <div className="sidebar-links">
            <a className="social-link" href={LINKEDIN_PROFILE_URL} target="_blank" rel="noreferrer" title="LinkedIn" aria-label="LinkedIn">
            ...
            <a className="social-link" href={GITHUB_PROFILE_URL} target="_blank" rel="noreferrer" title="GitHub" aria-label="GitHub">
              <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a className="social-link" href="mailto:matius.hariman@gmail.com" title="Email" aria-label="Email">
