    ...
    <>
      ...
      <div className="story-block">
        ...
        <p className="story-text">
          ...
          <a href={BAMBU_URL} target="_blank" rel="noreferrer">
      ...
      <div className="story-block">
        ...
        <p className="story-text">
          ...
          <a href={GOJEK_URL} target="_blank" rel="noreferrer">
            Gojek
          </a>{' '}
      ...
      <div className="story-block">
        ...
        <p className="story-text">
          ...
          <a href={BAMBU_GO_NEWS_URL} target="_blank" rel="noreferrer">
            BAMBU GO
          </a>
      ...
      <div className="story-block">
        ...
        <p className="story-text">
          ...
          <a href={YOUTRIP_URL} target="_blank" rel="noreferrer">
            YouTrip
          </a>
          , working as part of the Web team. I&apos;m currently leading the
